...
import { Row, Col, Progress, Badge, Tooltip, Spin, message } from 'antd';
import {
    ArrowUpOutlined,
    EyeOutlined,
    FileTextOutlined,
...
import { PRICING_CONFIG } from '@/lib/payment-service';
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-3xl border border-zinc-200 p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <Progress percent={80} showInfo={false} strokeColor="#6366f1" trailColor="#f3f4f6" />
                        ...
                        <div className="pt-6 border-t border-zinc-100">
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    { name: '抖音', status: '授权过期', color: 'bg-zinc-900', icon: '🎵', warning: true },
                                    ...
                                    <div key={p.name} className="flex items-center justify-between p-2 rounded-xl hover:bg-zinc-50 transition-all cursor-pointer">
                                        ...
                                        {p.warning ? (
                                            <Badge status="error" text="重连" className="cursor-pointer" />
                                        ) : (

        ...
        child: RefreshIndicator(
          ...
          child: CustomScrollView(
            slivers: [
              ...
              // Analytics Chart
              SliverToBoxAdapter(child: _buildSectionTitle('📈 Recent metrics')),
              ...
              // Winner Alert
              SliverToBoxAdapter(child: _buildSectionTitle('🔥 Viral alert')),
              ...
              // Content List
              SliverToBoxAdapter(child: _buildSectionTitle('📋 Content list')),
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              _buildStatColumn('Views', _formatNumber(summary.totalViews), Colors.blue),
              _buildStatColumn('Engagement', _formatNumber(summary.totalEngagement), Colors.orange),
              _buildStatColumn('Content', '${summary.totalContent}', Colors.green),
            ],
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Why: strong hook + short title + high engagement',
                ...
                child: ElevatedButton.icon(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Creating a replica...')),
                    );
                  },
